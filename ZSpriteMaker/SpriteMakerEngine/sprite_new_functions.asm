...
;===================================================================================================
; Get the distance between player and sprite
; Long function, return 16bit $02-$03 for the distance between player and sprite
; A is also equal to distance
;===================================================================================================
Sprite_DistanceBetweenLink:
REP #$20
LDA $0FD8 ; Sprite X
SEC : SBC $22 ; - Player X
BPL +
